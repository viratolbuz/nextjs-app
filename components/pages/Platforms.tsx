    ...
    <div className="space-y-6 animate-fade-in">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div className="min-w-0">
          <h1 className="text-xl sm:text-2xl md:text-[28px] font-display font-bold tracking-tight">Platform Management</h1>
          <p className="text-sm sm:text-[15px] text-muted-foreground">Manage advertising platforms and connections</p>
        </div>
