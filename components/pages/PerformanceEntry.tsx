              ...
              {paginated.map(e => {
                ...
                return (
                  <TableRow key={e.id}>
                    ...
                    <TableCell><Badge variant={proj?.type === 'Real Estate' ? 'secondary' : 'primary'} className="text-[12px]">{proj?.type || 'Lead Gen'}</Badge></TableCell>
                    ...
                    <TableCell><Badge variant="primary" className="text-[12px]">Active</Badge></TableCell>
                    <TableCell>
